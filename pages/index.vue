                        ...
                        <div class="float-right">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="font-size-12 text-muted">
                                                        <p class="mb-1">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم
                                                        </p>
                                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i> 3 دقیقه
                                                            پیش</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="font-size-12 text-muted">
                                                        ...
                                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i> 1 ساعت پیش
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="" class="text-reset notification-item">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="font-size-12 text-muted">
                                                        <p class="mb-1">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از
                                                            صنعت</p>
                                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i> 1 ساعت پیش
                                                        </p>
                                                    </div>
                            ...
                            <div class="dropdown d-inline-block">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="#"><i
                                            class="bx bx-wallet font-size-16 align-middle mr-1"></i> کیف پول من</a>
                                    <a class="dropdown-item d-block" href="#"><span
                                            class="badge badge-success float-right">11</span><i
                                            class="bx bx-wrench font-size-16 align-middle mr-1"></i> تنظیمات</a>
                                    <a class="dropdown-item" href="#"><i
                                            class="bx bx-lock-open font-size-16 align-middle mr-1"></i> قفل صفحه</a>
                                            ...
                                            <div class="carousel-item active">
                                                <div>
                                                    ...
                                                    <div class="media mt-4 pt-1">
                                                        ...
                                                        <div class="media-body">
                                                            <h5 class="font-size-16 mt-n2 mb-0 primary-font">استیو جابز
                                                            </h5>
                                            ...
                                            <div class="carousel-item">
                                                <div>
                                                    ...
                                                    <div class="media mt-4 pt-1">
                                                        ...
                                                        <div class="media-body">
                                                            <h5 class="font-size-16 mt-n2 mb-0 primary-font">تونی استارک
                                                            </h5>
                                            ...
                                            <div class="carousel-item">
                                                <div>
                                                    ...
                                                    <div class="media mt-4 pt-1">
                                                        ...
                                                        <div class="media-body">
                                                            <h5 class="font-size-16 mt-n2 mb-0 primary-font">بیل گیتس
                                                            </h5>
                                            ...
                                            <a href="#">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body overflow-hidden">
                                                        ...
                                                        <p class="text-truncate mb-0">لورم ایپسوم متن ساختگی با تولید
                                                        </p>
                                                    </div>
                                                    <div class="font-size-12 ml-2">
                                                        2 ساعت پیش
                                        ...
                                        <table class="table table-centered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>تونی استارک</td>
                                                    <td>125 تومان</td>
                                                    <td><span class="badge badge-soft-success font-size-12">پرداخت
                                                            شده</span></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>روبرتو کارلوس</td>
                                                    <td>118 تومان</td>
                                                    <td><span class="badge badge-soft-danger font-size-12">شارژ
                                                            شده</span></td>
                                                    <td><a href="#" class="btn btn-primary btn-sm">مشاهده</a></td>
                                                </tr>
                                                <tr>
